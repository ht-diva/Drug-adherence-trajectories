...
fe = fread("/media/volume/mferro/data/DRUGS/ADHERENCE_ANALYSIS_DRUG_HISTORY.Drug")
...
fwrite(list(colnames(fe)[-1]),"/media/volume/mferro/summary_stats/covariates_medication.csv")
...
fwrite(fe_p,"/media/volume/mferro/summary_stats/covariates_medication_prevalence_selection.csv")
...
diag(phis_dist) = 1
fwrite(phis_dist,"/media/volume/mferro/summary_stats/covariates_medication_distance_matrix.csv")
...
svg("/media/volume/mferro/plots/medication_trees.svg", width = 12, height = 6)
par(mfrow=c(1,3))
plot(C1,main="Complete Linkage", xlab="", sub="", cex=.9)
plot(C2, main="Single Linkage", xlab="", sub="", cex=.9)
plot((C3),main="Average Linkage", xlab="", sub="", cex=.9)
...
svg("/media/volume/mferro/plots/medication_selection.svg", width = 12, height = 6)
dis_plot
dev.off()
...
fwrite(fe_wide_s,"/media/volume/mferro/data/ADHERENCE/medication_covariates.csv")
