...
fe = fread("N:/output/data/acorbetta/STATINS/ADHERENCE/drugs_data.csv_all.gz")

ID = fe$COD_SOGGETTO


fwrite(list(colnames(fe)[-1]),"N:/output/data/acorbetta/STATINS/ADHERENCE/summary_stats/covariates_medication_all.csv")
...
fwrite(fe_p,"N:/output/data/acorbetta/STATINS/ADHERENCE/summary_stats/covariates_medication_prevalence_selection_all.csv")
...
diag(phis_dist) = 1
fwrite(phis_dist,"N:/output/data/acorbetta/STATINS/ADHERENCE/summary_stats/covariates_medication_distance_matrix_all.csv")
...
svg("N:/output/data/acorbetta/STATINS/ADHERENCE/plots/medication_trees_all.svg", width = 12, height = 6)
par(mfrow=c(1,3))
plot(C1,main="Complete Linkage", xlab="", sub="", cex=.9)
plot(C2, main="Single Linkage", xlab="", sub="", cex=.9)
plot((C3),main="Average Linkage", xlab="", sub="", cex=.9)
...
svg("N:/output/data/acorbetta/STATINS/ADHERENCE/plots/medication_selection_all.svg", width = 12, height = 6)
dis_plot
dev.off()
...
fwrite(fe_wide_s,"N:/output/data/acorbetta/STATINS/ADHERENCE/medication_covariates_all.csv")
